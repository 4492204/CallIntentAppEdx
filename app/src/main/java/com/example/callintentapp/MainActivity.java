        ...
        buttonCall.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isIntentSafe(callIntent)) {
                    ...
                    Toast.makeText(getApplicationContext(),"Your phone no app can dial",
        ...
        buttonMap.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(isIntentSafe(mapIntent)) {
                    ...
                    Toast.makeText(
                            getApplicationContext(), "Your phone not have map app",
                            Toast.LENGTH_SHORT
                    ).show();
                }
            }
        ...
        buttonWeb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(isIntentSafe(webIntent)) {
                    ...
                    Toast.makeText(getApplicationContext(), "Your phone not have web app",
                            Toast.LENGTH_SHORT).show();
    ...
    private void buttonMail() {
        ...
        buttonMail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                emailIntent.putExtra(Intent.EXTRA_EMAIL, new String[] {"hello@mail.ru, hi@all.ru"});
                ...
                if (isIntentSafe(emailIntent)) {
                    ...
                    Toast.makeText(getApplicationContext(), "Your phone not have e-mail app",
                            Toast.LENGTH_SHORT).show();
                }
